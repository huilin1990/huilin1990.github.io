...
Water samples were monthly collected from upstream and downstream Yukon River between July 2004 and September 2005. Strong seasonality was observed during the one-year monitoring. First flood in 2005 occurred in the middle of April. DOC concentration was consistent with discharge rate. Water from glacier and snowfield composites lower δ<sub>18</sub>O and δ<sub>2</sub>H. When temperature raised, large meltwater input negatived δ18O in the river water from average -17.5 ‰ in the winter to average 20.1 ‰.

![](\image\Yukon_2004\Discharge_DOC_18O_2H.jpg)

*Figure 2. Daily discharge (upper left panel), DOC concentration (bottom left panel), δ<sub>18</sub>O (upper right panel), and δ<sub>2</sub>H (bottom right panel) of sampling seasons between 2004 and 2005.*
...
Almost previous studies about Yukon River concerned about flood season in summer (Guo & Macdonald, 2006; Spencer et al., 2008; Striegl et al., 2007). Seldom researchers focused on slowly-moving river water under ice partly due to extreme weather conditions in Alaska (Guo et al., 2012). However, it is still important to know the mechanisms of Yukon River in winter. With respect to the water source, major contributor in winter is ‘whitewater’, which derives from relatively-eutrophic groundwater containing exceeding DIC and DIN (Guo et al., 2012). Additionally, hydrological dynamic under ice is inactive. Here we hypothesis that the stable ice-covered river water ecosystem capacitates stronger bio-activities compared to the highly-disturbed spring and summer.
